...
/**
 * A classe {@code Planta} representa um Pokémon do tipo Planta e contém métodos para calcular
...
public class Planta {
     ...
     *
     * @param oponente o tipo do Pokémon oponente (ex: "planta", "fogo").
     * @return o valor do ataque normal.
     */
    public int getAtaqueNormal(String oponente) {
        if(oponente.equals("planta")) {
            this.ataqueNormal = 2;
